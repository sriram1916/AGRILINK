...
constexpr UBaseType_t AGRILINK_TASK_PRIORITY_SENSORS = configMAX_PRIORITIES - 6;
constexpr UBaseType_t AGRILINK_TASK_PRIORITY_FAULT_INJECTION = configMAX_PRIORITIES - 6;
constexpr UBaseType_t AGRILINK_TASK_PRIORITY_TESTS = configMAX_PRIORITIES - 6;
